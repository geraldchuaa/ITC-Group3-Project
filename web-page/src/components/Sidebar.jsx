    ...
    return (
        <aside className="w-[280px] bg-white border-r border-gray-200 flex flex-col h-screen sticky top-0 shadow-sm">
            ...
            <div className="p-6 border-t border-gray-100 space-y-3">
                ...
                <button onClick={() => router.push("/")} className="w-full flex items-center space-x-4 px-4 py-3 rounded-2xl font-bold text-sm uppercase tracking-wider transition-colors text-red-500 hover:bg-red-50 hover:text-red-700 cursor-pointer">
